...
$product_variant_id = $oProduct->variation_id;
$vat_atts = $oProduct->get_variation_attributes();
?>
<tr class="uni-wishlist-table-row<?php if ( $i == 1 ) { echo ' row-odd'; } else { echo ' row-even'; } ?>">
    ...
    <td>
        <div class="uni-wishlist-item-details">
            ...
            <div class="uni-wishlist-variation-details">
                <?php echo wc_get_formatted_variation( $vat_atts ); ?>
            </div>
    ...
    <td>
        ...
        echo '<a href="#" class="uni-wishlist-table-remove-link" data-pid="'.$product_id.'" data-vid="'.$product_variant_id.'" data-action="uni_wishlist_delete_from_list">'.$sRemoveItemTitle.'</a>';
        ?>
    </td>
</tr>