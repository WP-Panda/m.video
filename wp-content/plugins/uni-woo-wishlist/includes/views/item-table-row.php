...
<tr class="uni-wishlist-table-row<?php if ( $i == 1 ) { echo ' row-odd'; } else { echo ' row-even'; } ?>">
    ...
    <td>
        <?php
        $sRemoveItemTitle = apply_filters( 'uni_wc_wishlist_table_remove_item_link', '<i class="fa fa-trash-o"></i>', 'not-variable' );
        echo '<a href="#" class="uni-wishlist-table-remove-link" data-pid="'.$iProductId.'" data-action="uni_wishlist_delete_from_list">'.$sRemoveItemTitle.'</a>';
        ?>
    </td>
</tr>