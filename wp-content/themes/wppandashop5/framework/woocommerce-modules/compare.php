 ...
 */
function cr_compare_tab_options_tab() { ?>
    <li class="cr_modules"><a href="#cr_compare"><?php _e('В сравнение', 'woothemes'); ?></a></li>
    <?php
}
add_action('woocommerce_product_write_panel_tabs', 'cr_compare_tab_options_tab');

/**
 * Контент блока нашли девле
 */
function cr_compare_tab_options() {
    global $post;
...
add_action('woocommerce_product_write_panels', 'cr_compare_tab_options');