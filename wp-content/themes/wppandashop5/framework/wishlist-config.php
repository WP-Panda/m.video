...
class YITH_WCWL_UIU extends YITH_WCWL_UI  {
    /**
    ...
    public static function add_to_wishlist_button( $url, $product_type, $exists ) {
       ...
       // $label_option = get_option( 'yith_wcwl_add_to_wishlist_text' );
        ...
        $html .= '><a href="' . esc_url( $yith_wcwl->get_addtowishlist_url() ) . '" data-product-id="' . $product->id . '" data-product-type="' . $product_type . '" class="btn btn-primary whislist add_to_wishlist" ><i class="fa fa-exchange"></i></a>';
